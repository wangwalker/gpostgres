...
func TestBtreeWhenHasDefaultDegree(t *testing.T) {
	...
	// WHEN
	tree.Insert(makeKey("food", 10), "t1", "c1")
	tree.Insert(makeKey("f", 11), "t1", "c1")
	tree.Insert(makeKey("hi", 12), "t1", "c1")
	tree.Insert(makeKey("internet", 13), "t1", "c1")
	tree.Insert(makeKey("j", 14), "t1", "c1")
	tree.Insert(makeKey("kitty", 15), "t1", "c1")
	tree.Insert(makeKey("loop", 16), "t1", "c1")
	tree.Insert(makeKey("m", 17), "t1", "c1")
	tree.Insert(makeKey("string", 18), "t1", "c1")
...
func TestBtreeWhenDegreeIs10(t *testing.T) {
	...
	// WHEN
	tree.Insert(makeKey("food", 10), "t2", "c1")
	tree.Insert(makeKey("f", 11), "t2", "c1")
	tree.Insert(makeKey("hi", 12), "t2", "c1")
	tree.Insert(makeKey("internet", 13), "t2", "c1")
	tree.Insert(makeKey("j", 14), "t2", "c1")
	tree.Insert(makeKey("kitty", 15), "t2", "c1")
	tree.Insert(makeKey("loop", 16), "t2", "c1")
